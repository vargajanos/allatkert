...
class Pet_Business_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'pet_business';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'pet-business' ), $i ),
...
// Initialize.
$pet_business_footer_widgets = new Pet_Business_Footer_Widgets();
